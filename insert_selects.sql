...
(10006,'d004','1985-01-01','1988-09-09'),
(10007,'d004','1988-09-09','1992-08-02'),
(10008,'d004','1992-08-02','1996-08-30'),
(10009,'d004','1996-08-30','9999-01-01'),
...
/*para localizar os valores exclusivos de três coluna na tabela employees e ordena os nomes, data de contratação e sobrenome de forma crescente.*/
SELECT DISTINCT first_name, hire_date, last_name
FROM employees
ORDER BY first_name, hire_date, last_name asc;
...
/*Agrupamos os dados da tabela departaments pelo campoo dept_name*/
SELECT dept_name  FROM  departments GROUP BY  dept_name ;


/*Filtro na tabela employes cujo o nome das pessoas sejam somente Georgi, Parto, Chirstian, Kyoichi*/
SELECT first_name
FROM employees
WHERE first_name IN ('Georgi', 'Parto', 'Chirstian', 'Kyoichi');

/*Filtro na tabela employes cujo o nome das pessoas não sejam Adly, Christoper, Cordelia, Danell*/
SELECT  first_name
FROM employees
WHERE first_name  NOT IN ('Adly', 'Christoper', 'Cordelia', 'Danel');

/*Filtro na tabela employes cujo a data de contratação seja 1994*/
SELECT hire_date
FROM employees
WHERE hire_date LIKE '%1994%';

/*Filtro para todos os salários preenchidos da tabela salaries*/
SELECT   salary   
FROM salaries
WHERE   salary IS NOT NULL;

/*Filtro para todos os salários  de 46671 á 80083 da tabela salares*/
SELECT salary  
FROM salaries
WHERE salary BETWEEN 46671 AND  80083;

/* Filtro para todas as pessoas cuja a coluna gender tenha o valor dififerente de 'M'*/
SELECT  frist_name, gender
FROM employees
WHERE gender <> 'M';

/*agrupamos os campos first_name e last_name a apos  retornamos a/as pessoas que foram contratadas 19520824*/
SELECT  first_name, last_name , SUM( birth_date) AS ' Data de contratação'
FROM employees
GROUP BY first_name, last_name 
HAVING SUM(birth_date) = 19520824;


/* Retornar todos os registros da tabela  employes cujo a birth_date  é maior do que  1985-07-05 ou menor que <=1996-04-13*/
SELECT  birth_date
FROM employees
WHERE birth_date > 1985-07-05 OR birth_date <=1996-04-13
order by birth_date desc;

/*Filtro para retorna salarios maiores ou iguais a 85400*/
SELECT *
FROM salaries
GROUP BY salary
HAVING salary >= 85400;

/*Filtro para retorna os salarios 60.117 e 86.157*/
SELECT *
FROM salaries
WHERE salary = 60117 OR  salary = 86157;


/* consultas yasmin */

/* Inner join -> Juntar a tabela employes com a salaries+ / campos nome, sobrenome, id especifico e salario*/ 
...
WHERE employees.emp_no in (10001, 10002, 10003);


/*right join -> Retorna todas as linhas da tabela direita com as correspondencia da esquerda  arruma */
Select first_name, last_name 
FROM employees RIGHT OUTER JOIN dept_manager
on employees.emp_no = dept_manager.emp_no;

/* left join -> Retorna todas as linhas da tabela esquerda com as correspondencia da direita arruma*/
...
/* Union*/
/* Selecionar todas pessoas os nomes de pessoas que possui o genero feminino */ 
...
/*altera o campo nome da tabela imployees para 20 caracteres*/
alter table employees modify first_name varchar(20);


/* consultas thiago */
/* Utilizando subquarie para verificar o maior salario*/
SELECT  
		emp_no,
		salary
from salaries
...
SELECT e.first_name,
	...
	from salaries s
where exists
(select  salary from employees e where s.emp_no= e.emp_no );
